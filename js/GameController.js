...
function GameController($firebaseObject, $scope){
    ...
    $scope.playerMove = function(location) {
		//switches player 1 turn on and off
    	//occupied square cannot be played
    	//
	...
	$scope.clearBoard = function() {
	 	// when the button is clicked, the cell values reset to 0, and playerOneTurn resets to true.
	 	for (var i = 0; i < 9; i++) {
